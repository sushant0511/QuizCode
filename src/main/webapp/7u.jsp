...
st = conn.createStatement();
String query = "SELECT * FROM "+table+" where id='7'";
...
String g=null;
int count11 = Integer.parseInt(session.getAttribute("count10").toString());
...
String ins="UPDATE "+tableforins+" SET q7='"+count11+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);



System.out.println("ansewer="+count11);
session.setAttribute("count12", count11);
response.sendRedirect("chequesub8.jsp");
