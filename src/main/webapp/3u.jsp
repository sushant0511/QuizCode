...
st = conn.createStatement();
// this is faulty table where id is primary key
...
String g=null;
int count3 = Integer.parseInt(session.getAttribute("count3").toString());
...
String ins="UPDATE "+tableforins+" SET q3='"+count3+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);


System.out.println("ansewer="+count3);
session.setAttribute("count4", count3);
response.sendRedirect("chequesub4.jsp");
