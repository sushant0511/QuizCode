...
st = conn.createStatement();
String query = "SELECT * FROM "+table+" where id='9'";
...
String g=null;
int count15 = Integer.parseInt(session.getAttribute("count14").toString());
...
String ins="UPDATE "+tableforins+" SET Q9='"+count15+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);



System.out.println("ansewer="+count15);
session.setAttribute("count16", count15);
response.sendRedirect("chequesub10.jsp");
