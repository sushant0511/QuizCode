...
String g=null;
int count7 = Integer.parseInt(session.getAttribute("count6").toString());
...
String ins="UPDATE "+tableforins+" SET Q5='"+count7+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);



System.out.println("ansewer="+count7);
session.setAttribute("count8", count7);
response.sendRedirect("chequesub6.jsp");
