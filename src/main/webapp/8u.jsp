...
st = conn.createStatement();
String query = "SELECT * FROM "+table+" where id='8'";
...
String g=null;
int count13 = Integer.parseInt(session.getAttribute("count12").toString());
...
String ins="UPDATE "+tableforins+" SET Q8='"+count13+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);


System.out.println("ansewer="+count13);
session.setAttribute("count14", count13);
response.sendRedirect("chequesub9.jsp");
