...
st = conn.createStatement();
String query = "SELECT * FROM "+table+" where id='2'";
...
String g=null;
int count2 = Integer.parseInt(session.getAttribute("count1").toString());
...
String ins="UPDATE "+tableforins+" SET q2='"+count2+"' WHERE `semail`='"+email+"'";

st.executeUpdate(ins);

System.out.println("ansewer="+count2);
session.setAttribute("count3", count2);
response.sendRedirect("chequesub3.jsp");
